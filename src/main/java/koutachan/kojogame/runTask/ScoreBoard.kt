    ...
    fun scoreboardupdate(){
        Bukkit.getScheduler().runTaskTimer(plugin, {
            for (player in Bukkit.getOnlinePlayers()) {
                ...
                val line2 = lang.LengthCheck(config.getString("SCOREBOARD_LINE2").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line3 = lang.LengthCheck(config.getString("SCOREBOARD_LINE3").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line4 = lang.LengthCheck(config.getString("SCOREBOARD_LINE4").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line5 = lang.LengthCheck(config.getString("SCOREBOARD_LINE5").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line6 = lang.LengthCheck(config.getString("SCOREBOARD_LINE6").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line7 = lang.LengthCheck(config.getString("SCOREBOARD_LINE7").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
                val line8 = lang.LengthCheck(config.getString("SCOREBOARD_LINE8").replace("@state", GameState.toString().replace("LOBBY","${config.get("GAMESTATE_LOBBY")}").replace("STARTING","${config.get("GAMESTATE_STARTING")}").replace("PLAYING","${config.get("GAMESTATE_PLAYING")}").replace("ENDING","${config.get("GAMESTATE_ENDING")}")).replace("@start","$starttime").replace("@time","$time").replace("@randomint","${Random.nextInt(100000)}").replace("@playername",player.name).replace("@usedmem","${(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576}").replace("@maxmem", "$maxmem").replace("@irons","$SpongeIron".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_IRON_FALSE")}")).replace("@golds","$SpongeGold".replace("true","${config.get("SCOREBOARD_IRON_TRUE")}").replace("false","${config.get("SCOREBOARD_GOLD_FALSE")}")).replace("@diamonds","$SpongeDiamond".replace("true","${config.get("SCOREBOARD_DIAMOND_TRUE")}").replace("false","${config.get("SCOREBOARD_DIAMOND_FALSE")}")))
